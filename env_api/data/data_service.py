...
class DataSetService:
    def __init__(self, cpps_dataset_path=None, schedules_dataset_path=None):
        ...
        try:
            ...
            print(
                "[Error] : Offline dataset path is not valid => Reading from cpp files on disk"
            )

        if schedules_dataset_path is not None:
            try:
